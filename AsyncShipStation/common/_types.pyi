...
ErrorTypes = Literal['account_status', 'business_rules', 'validation', 'security', 'system', 'integrations']
...
DisplayFormatSchemes = Literal['label', 'qr_code', 'label_and_qr_code', 'paperless', 'label_and_paperless']
...
OrderSources = Literal['amazon_ca', 'amazon_us', 'brightpearl', 'channel_advisor', 'cratejoy', 'ebay', 'etsy', 'jane', 'groupon_goods', 'magento', 'paypal', 'seller_active', 'shopify', 'stitch_labs', 'squarespace', 'three_dcart', 'tophatter', 'walmart', 'woo_commerce', 'volusion']
...
DeliveryConfirmationMethods = Literal['none', 'delivery', 'signature', 'adult_signature', 'direct_signature', 'delivery_mailed', 'verbal_confirmation']
...
IncoTerms = Literal['exwfca', 'cpt', 'cip', 'dpu', 'dap', 'ddp', 'fas', 'fob', 'cfr', 'cif', 'ddu', 'daf', 'deq', 'des']
...
class V1Address(TypedDict):
    ...
    phone: str | None
    residential: bool
    addressVerified: Literal['Address not yet validated', 'Address validated successfully', 'Address validation warning', 'Address validation failed'] | None
