...
class LabelPortal(ShipStationClient):
    ...
    async def list(
        ...
        endpoint = f"{cls._endpoint}/{Endpoints.LABELS.value}"
    ...
    async def purchase_with_rate_id(
        ...
        endpoint = f"{cls._endpoint}/{Endpoints.LABELS.value}/rates/{rate_id}"
    ...
    async def purchase_with_shipment_id(
        ...
        endpoint = f"{cls._endpoint}/{Endpoints.LABELS.value}/shipment/{shipment_id}"
    ...
    async def create_return_label(
        ...
        endpoint = f"{cls._endpoint}/{Endpoints.LABELS.value}/{label_id}/return"
